...
while ((match = matches.next()).done !== true) {
    ...
    const valueDefault = groups.default ? groups.default.trim() : null;
...
fs.writeFileSync(CACHE_DIR + "test.html", `
<html>
<body>
${result}
</body>
...
//fs.writeFileSync(CACHE_DIR + "test.json", JSON.stringify(array), {encoding: "utf-8"})
